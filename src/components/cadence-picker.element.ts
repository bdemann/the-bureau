...
export function defaultCadenceConfig(
    ...
    return {
        cadence,
        scheduleMode:
            cadence === "daily" || cadence === "multiple_per_day"
                ? "rolling"
                : "fixed",
...
export function cadenceConfigFromRecurrence(
    ...
    return {
        ...
        daysOfWeek: new Set(
            rawDaysOfWeek ?? [base.daysOfWeek.values().next().value ?? 1],
        ),
        monthAnchorMode:
            (cfg.cadence === "monthly" || cfg.cadence === "quarterly") &&
            cfg.ordinalWeek !== undefined
                ? "ordinal"
                : "dom",
        yearAnchorMode:
            cfg.cadence === "annually" && cfg.ordinalWeek !== undefined
                ? "ordinal"
                : "dom",
        daysOfMonth: new Set(
            cfg.hardDaysOfMonth ??
        ...
        dayOfMonth:
            cfg.hardDayOfMonth ?? cfg.hardDaysOfMonth?.[0] ?? base.dayOfMonth,
 ...
 */
export function buildRecurrenceAnchors(
    config: CadenceConfig,
): Partial<RecurrenceConfig> {
    switch (config.cadence) {
        ...
        case "monthly": {
            if (config.monthAnchorMode === "ordinal") {
                return {
                    ...
                    ...(config.ordinalOffset !== 0
                        ? { ordinalOffset: config.ordinalOffset }
                        : {}),
                };
            }
        ...
        case "quarterly": {
            ...
            return sorted.length > 1
                ? {
                      hardMonthOfQuarter: config.quarterMonth,
                      hardDaysOfMonth: sorted,
                  }
                : {
                      hardMonthOfQuarter: config.quarterMonth,
...
const CADENCE_BUTTONS: ReadonlyArray<{
...
const ORDINAL_VALUES: ReadonlyArray<1 | 2 | 3 | 4 | 5 | -1> = [
    1, 2, 3, 4, 5, -1,
];
...
export const CadencePickerElement = defineElement<{ config: CadenceConfig }>()({
    ...
    render({ inputs, dispatch, events }) {
        ...
        const isDaily =
            config.cadence === "daily" || config.cadence === "multiple_per_day";
                      ...
                      <div class="field">
                        ...
                        `,
                          ...
                          <div class="anchor-summary">
                              ${formatSelectedDays(config.daysOfWeek)}
                          </div>
                      </div>
                  `
                : html``}
                ...
                <div class="field">
                    ...
                    <div class="grid-2">
                        ...
                        <${ViraButton.assign({
                            ...
                            color: ViraColorVariant.Info,
                            buttonEmphasis:
                                config.monthAnchorMode === "ordinal"
                                    ? ViraEmphasis.Standard
                                    : ViraEmphasis.Subtle,
                            buttonSize: ViraSize.Small,
                        })}
                    ...
                    config.monthAnchorMode === "dom"
                        ? html`
                            ...
                            `,
                                  ...
                                  <div class="anchor-summary">
                                      ${formatSelectedDoms(config.daysOfMonth)}
                                  </div>
                              </div>
                          `
                        : html`
                            ...
                            `,
                                  ...
                                  <div class="anchor-summary">
                                      The
                                      ${config.ordinalWeek === -1
                                          ? "last"
                                          : ordinalSuffix(config.ordinalWeek)}
                                      ${DAY_LABELS.find(
                                          (d) => d.value === config.dayOfWeek,
                                      )?.label ?? ""}
                                      of each
                                      month${config.ordinalWeek === 5
                              ...
                              <div class="field">
                                  ...
                                  <input
                                      ...
                                      @change=${(e: Event) => {
                                          ...
                                          if (!Number.isNaN(n))
                                              update({ ordinalOffset: n });
                                      }}
                                  />
                                  <div class="anchor-summary">
                                      ${ordinalOffsetLabel(
                                          config.ordinalOffset,
                                      )}
                                  </div>
                              </div>
                          `
                ...
                ? html`
                      <div class="field">
                        ...
                        `,
                          ...
                          <div class="anchor-summary">
                              ${quarterMonthSummary(config.quarterMonth)}
                          </div>
                      </div>
                      <div class="field">
                        ...
                        : html`
                            ...
                            `,
                                  ...
                                  <div class="anchor-summary">
                                      ...
                                      of
                                      ${MONTH_LABELS.find(
                                          (m) => m.value === config.annualMonth,
                                      )?.label ?? ""}
                                      each
                                      year${config.ordinalWeek === 5
                                          ? " (skips years where that month lacks a 5th)"
                                          : ""}.
                                  </div>
                              </div>
                              <div class="field">
