...
import type {FormKind, Goal, Idea, Project, ProjectColor, Task} from '../data/types.js';
...
export const ProjectDetailElement = defineElement<{
    ...
    events: {
        ...
        newCommitmentRequested:  defineElementEvent<{projectId: string; kind: FormKind}>(),
            ...
            <div class="delete-zone">
                ${state.editingProject
                    ? html`
                        <div class="edit-form">
                            <div>
                                <label class="edit-label">Area Name</label>
                                <input
                                    class="edit-input"
                                    type="text"
